...
namespace ceps2openv2g{
    ...
    template<> iso2DC_EVBidirectionalParameterType MessageBuilder::emit<iso2DC_EVBidirectionalParameterType>(ceps::ast::Struct & msg){
     ...
     template<> node_t MessageBuilder::strct(iso2DC_EVBidirectionalParameterType v){
        return rec("EVChargeParameterType",
            ...
            v.EVMaximumDischargePower_isUsed == 1? rec("EVMaximumDischargePower",v.EVMaximumDischargePower):unused,
            v.EVMinimumDischargePower_isUsed == 1? rec("EVMinimumDischargePower",v.EVMinimumDischargePower):unused,
            rec("EVMaximumDischargeCurrent",v.EVMaximumDischargeCurrent),
            rec("EVMinimumDischargeCurrent",v.EVMinimumDischargeCurrent),
            rec("EVMinimumVoltage",v.EVMinimumVoltage),
            v.MinimumSOC_isUsed == 1? rec("MinimumSOC",v.MinimumSOC_isUsed):unused
        );    
    }
}